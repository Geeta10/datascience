...
```
#HousePrice regression Model

#I have selected some of the attributes that are important for my model based on the above analysis
# Then  I made linear regression model which could best predict the house Prices .
...
rn_train <- sample(nrow(newHousePrice),floor(nrow(newHousePrice)*0.6))
